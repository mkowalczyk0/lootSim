...
| 11 — World / tower / delve | tower climbing, heaven/hell split, lore integration | §22 lore and §23 layers **done**; §21 Tower in flight |
...
| 21 | Titan rush / tower | **in flight** | Opus 5, `feat/world-structure` Part B. The ascending counterpart to the Delve: seventh `RunMode`, endless, through the one difficulty curve with effective depth = height. Holy element throughout, the Celestial Hierarchy as its roster, borrowed-and-reskinned encounters, and one tower-only mechanic (light punishes standing still — the inverse of a Hell AoE you dodge out of). The layer table already carries its three bands. |
