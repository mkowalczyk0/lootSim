...
class LootSystemGUI(tk.Frame):
    ...
    def create_inventory_section(self):
        ...
        self.left_frame.grid_columnconfigure(0, weight=1)  # Single column layout
        ...
        self.inventory_frame.grid_rowconfigure(0, weight=1)  # Ensure the row expands
        self.inventory_frame.grid_columnconfigure(0, weight=1)  # Ensure the column expands
        ...
        self.inventory_display = tk.Listbox(
            self.inventory_frame, 
            yscrollcommand=self.inventory_scroll.set, 
            selectmode="multiple"
        )
        self.inventory_display.grid(row=0, column=0, sticky="nsew")
